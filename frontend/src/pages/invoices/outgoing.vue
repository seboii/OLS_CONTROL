<template>
  <div>
    <div class="w-full lg:max-w-(--breakpoint-xl) lg:mx-auto">
      <div>
        <div class="mb-4 lg:mb-8 flex justify-between items-center gap-6">
          <div>
            <h2 class="text-gray-800 font-medium text-4xl tracking-tight">Gelir Faturalar</h2>
            <div class="text-gray-500 text-sm mt-1">Gelir faturalarınızı görüntüleyebilirsiniz.</div>
          </div>
    ...
    <InvoiceFormDrawer v-model:visible="invoice_form_drawer_visible" v-model:invoice-id="invoice_id" :box-type="1" @hide="onHideInvoiceFormDrawer" />
  </div>
</template>
